<%-- 
    Document   : semana
    Created on : 2/12/2020, 03:23:28 PM
    Author     : Jose
--%>
...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/graficaLinea.js"></script>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Ultima Semana</h6>
                                </div>
                                <div >
